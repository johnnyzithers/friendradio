...
var chan=basslib.BASS_StreamCreateFile(0,'./web/testo.mp3',0,0,basslib.BASSFlags.BASS_STREAM_DECODE | basslib.BASSFlags.BASS_SAMPLE_FLOAT)
...
var result = basslib.BASS_Encode_CastInit(enc_chan,
 ...
 // basslib.BASS_ChannelPlay(mixer,-1);    
// 
// console.log("play error?: " + basslib.BASS_ErrorGetCode()); // 0 is ok, 2 is fileopen
...
setInterval(function(){
    ...
    // console.log("chan active: ", basslib.BASS_ChannelIsActive(chan));
    // console.log("enc_chan active: ", basslib.BASS_ChannelIsActive(enc_chan));
    // console.log("mixer active: ", basslib.BASS_ChannelIsActive(mixer));
    // console.log("is playing?: ", basslib.BASS_ChannelIsActiveAttribs.BASS_ACTIVE_PLAYING)
